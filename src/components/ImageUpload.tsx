...
const ImageUpload: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-4">
      <div
        className="border-2 w-[150px] h-[150px] relative border-gray-300 rounded-full border-dashed flex items-center justify-center cursor-pointer"
      ...
      >
        {imagePreview ? (
          ...
          <div className="text-center">
            ...
            <label
              htmlFor="imageUpload"
              className="absolute text-primary p-2 rounded-full bg-white cursor-pointer mt-2 bottom-0 right-2"
            >
              <Pen size={16}/>
            </label>
          </div>
